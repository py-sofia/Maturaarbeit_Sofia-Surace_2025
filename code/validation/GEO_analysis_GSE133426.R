...
gset <- getGEO("GSE133426", GSEMatrix =TRUE, AnnotGPL=TRUE)
...
tT <- subset(tT, select=c("ID","adj.P.Val","P.Value","t","B","logFC","GI","Platform_SEQUENCE","Gene.symbol","Gene.title"))
# changed "SEQUENCE" to "Platform_SEQUENCE", removed "GB_ACC"
...
par(mar=c(7,4,2,1))
title <- paste ("GSE133426", "/", annotation(gset), sep ="")
boxplot(ex[,ord], boxwex=0.6, notch=T, main=title, outline=FALSE, las=2, col=gs[ord])
legend("topleft", groups, fill=palette(), bty="n")

# expression value distribution
par(mar=c(4,4,2,1))
title <- paste ("GSE133426", "/", annotation(gset), " value distribution", sep ="")
...
plotSA(fit2, main="Mean variance trend, GSE133426")
